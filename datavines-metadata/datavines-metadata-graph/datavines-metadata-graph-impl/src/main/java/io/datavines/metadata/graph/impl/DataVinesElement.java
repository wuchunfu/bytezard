...
import io.datavines.metadata.graph.api.IElement;
 ...
 * that is stored.
 */
public class DataVinesElement<T extends Element> implements IElement {

    private final T element;

    protected DataVinesGraph graph;

    public DataVinesElement(DataVinesGraph graph, T element) {

...
public enum Status {
    ...
    INTERPRETER_OPERATOR_EXECUTE_QUERY_ERROR(17010001,"Execute Query Error","执行查询失败"),
    INTERPRETER_OPERATOR_EXECUTE_QUERY_RESULT_TYPE_ERROR(17010002,"Result Type Not Found Error",""),
    INTERPRETER_OPERATOR_EXECUTE_SQL_NULL_ERROR(17010003,"Execute Sql is Null Error","SQL为空"),

    //API 模块
    API_REGISTER_ERROR(14010001,"API Register Error", "API注册失败"),
    API_REGISTER_PATH_AND_METHOD_ERROR(14010002,"API Register (Path + Method) Error", "API注册路径、请求方式重复"),
    API_SAVE_ERROR(14010003,"API Save Error", "API保存失败"),
    API_UPDATE_ERROR(14010004,"API Update Error", "API更新失败"),

    //数据管理
    DATASOURCE_IS_EXIST_ERROR(13010001,"DataSource {0} Is Exist Error","数据源 {0} 已存在"),
    DATASOURCE_IS_NOT_EXIST_ERROR(13010002,"DataSource {0} Is Exist Not Error","数据源 {0} 不存在"),
    DATASOURCE_CREATE_ERROR(13010003,"Create DataSource {0} Error","创建数据源 {0} 失败"),
    DATASOURCE_UPDATE_ERROR(13010004,"Update DataSource {0} Error","更新数据源 {0} 失败"),

    //数据可视化
    VIEW_IS_EXIST_ERROR(15010001,"View {0} Is Exist Error","视图 {0} 已存在"),
    VIEW_IS_NOT_EXIST_ERROR(15010002,"View {0} Is Exist Not Error","视图 {0} 不存在"),
    VIEW_CREATE_ERROR(15010003,"Create View {0} Error","创建视图 {0} 失败"),
    VIEW_UPDATE_ERROR(15010004,"Update View {0} Error","更新视图 {0} 失败"),
    VIEW_PREVIEW_DATA_ERROR(15010005,"View Preview Data Error {0} ","预览数据失败 {0}"),
    VIEW_UNION_COLUMN_NOT_SAME_ERROR(15010005,"View Union Column Not Same Error","合并视图的表字段数量和类型不一致"),
    VIEW_DATABASE_IS_EXIST_ERROR(15020001,"View Database {0} Is Exist Error","视图库 {0} 已存在"),
    VIEW_DATABASE_IS_NOT_EXIST_ERROR(15020002,"View Database {0} Is Not Exist Error","视图库 {0} 不存在"),
    VIEW_DATABASE_CREATE_ERROR(15020003,"Create View Database {0} Error","创建视图库 {0} 失败"),
    VIEW_DATABASE_UPDATE_ERROR(15020004,"Update View Database {0} Error","更新视图库 {0} 失败"),
    VIEW_DATABASE_DELETE_ERROR(15020005,"Delete Database {0} Error","删除视图库 {0} 失败 "),
    WIDGET_IS_EXIST_ERROR(15030001,"Widget {0} Is Exist Error","组件 {0} 已存在"),
    WIDGET_IS_NOT_EXIST_ERROR(15030002,"Widget {0} Is Exist Not Error","组件 {0} 不存在"),
    WIDGET_CREATE_ERROR(15030003,"Create Widget {0} Error","创建组件 {0} 失败"),
    WIDGET_UPDATE_ERROR(15030004,"Update Widget {0} Error","更新组件 {0} 失败"),
    DASHBOARD_IS_EXIST_ERROR(15040001,"Dashboard {0} Is Exist Error","看板 {0} 已存在"),
    DASHBOARD_IS_NOT_EXIST_ERROR(15040002,"Dashboard {0} Is Exist Not Error","看板 {0} 不存在"),
    DASHBOARD_CREATE_ERROR(15040003,"Create Dashboard {0} Error","创建看板 {0} 失败"),
    DASHBOARD_UPDATE_ERROR(15040004,"Update Dashboard {0} Error","更新看板 {0} 失败"),
    DASHBOARD_WIDGET_CREATE_ERROR(15040005,"Create DashboardWidgets {0} Error","创建看板组件失败"),
    DASHBOARD_WIDGET_UPDATE_ERROR(15040006,"Update DashboardWidgets {0} Error","更新看板组件失败"),

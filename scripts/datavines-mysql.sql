...
CREATE TABLE `datavines_command` (
...
CREATE TABLE `datavines_execution_job` (
...
CREATE TABLE `datavines_job_definition` (
...
CREATE TABLE `datavines_job_instance` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `datavines_project` (

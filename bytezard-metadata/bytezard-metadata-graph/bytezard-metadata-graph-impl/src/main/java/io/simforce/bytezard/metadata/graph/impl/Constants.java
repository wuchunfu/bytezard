...
public final class Constants {
    ...
    public static final String TYPE_DESCRIPTION_PROPERTY_KEY = getEncodedTypePropertyKey(INTERNAL_PROPERTY_KEY_PREFIX + "type.description");
    public static final String TYPE_VERSION_PROPERTY_KEY = getEncodedTypePropertyKey(INTERNAL_PROPERTY_KEY_PREFIX + "type.version");
    public static final String TYPE_OPTIONS_PROPERTY_KEY = getEncodedTypePropertyKey(INTERNAL_PROPERTY_KEY_PREFIX + "type.options");
    public static final String TYPE_SERVICETYPE_PROPERTY_KEY = getEncodedTypePropertyKey(INTERNAL_PROPERTY_KEY_PREFIX + "type.servicetype");

    // relationship def constants
    public static final String RELATIONSHIP_TYPE_END1_KEY = "endDef1";
    public static final String RELATIONSHIP_TYPE_END2_KEY = "endDef2";
    public static final String RELATIONSHIP_TYPE_CATEGORY_KEY = "relationshipCategory";
    public static final String RELATIONSHIP_TYPE_LABEL_KEY = "relationshipLabel";
    public static final String RELATIONSHIP_TYPE_TAG_PROPAGATION_KEY = encodePropertyKey("tagPropagation");
    public static final String RELATIONSHIP_TYPE_BLOCKED_PROPAGATED_CLASSIFICATIONS_KEY = encodePropertyKey("blockedPropagatedClassifications");
    ...
    /**
     * The homeId field is used when saving into  a copy of an object that is being imported from another
     ...
     * An object that is mastered by the  repository, will have a null homeId field. This represents a locally
     * mastered object that can be manipulated by  and its applications as normal.
    ...
    /**
     * The isProxy field is used when saving into  a proxy of an entity - i.e. it is not a whole entity, but
     ...
     * entity (proxy) from  to indicate that the entity does not contain full entity detail.
     */
    ...
    public static final String INDEX_SEARCH_MAX_RESULT_SET_SIZE        = "graph.index.search.max-result-set-size";
    public static final String INDEX_SEARCH_TYPES_MAX_QUERY_STR_LENGTH = "graph.index.search.types.max-query-str-length";
    public static final String INDEX_SEARCH_TAGS_MAX_QUERY_STR_LENGTH  = "graph.index.search.tags.max-query-str-length";
    public static final String INDEX_SEARCH_VERTEX_PREFIX_PROPERTY     = "graph.index.search.vertex.prefix";
    public static final String INDEX_SEARCH_VERTEX_PREFIX_DEFAULT      = "$v$";

    public static final String MAX_FULLTEXT_QUERY_STR_LENGTH = "graph.fulltext-max-query-str-length";
    public static final String MAX_DSL_QUERY_STR_LENGTH      = "graph.dsl-max-query-str-length";
    ...
    public static final String TERM_ASSIGNMENT_LABEL                          = "r:GlossarySemanticAssignment";
    ...
    public static final String TASK_TYPE_NAME         = INTERNAL_PROPERTY_KEY_PREFIX + "TaskDef";
...
//
//            if (configuration.containsKey("graph.index.search.backend") &&
//                    configuration.getString("graph.index.search.backend").equals("elasticsearch")) {
//

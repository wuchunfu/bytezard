...
public class TypeDefHeader implements java.io.Serializable {
    ...
    public TypeDefHeader() {
        this(null, null, null);
    }

    public TypeDefHeader(String guid, String name, TypeCategory category) {
        this.guid = guid;
        this.name = name;
        this.category = category;
    }

    public TypeDefHeader(String guid, String name, TypeCategory category, String serviceType) {
        this(guid, name, category);
        this.serviceType = serviceType;
    }

    public TypeDefHeader(BaseTypeDef typeDef) {
        this(typeDef.getGuid(), typeDef.getName(), typeDef.getCategory(), typeDef.getServiceType());
    }

    public TypeDefHeader(TypeDefHeader other) {
        super();
        if (other == null) {
            setGuid(null);
            setName(null);
    ...
    public boolean equals(Object o) {
        ...
        TypeDefHeader that = (TypeDefHeader) o;

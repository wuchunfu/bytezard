...
public class ClassificationDef extends StructDef implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    private Set<String> superTypes;
    private Set<String> entityTypes;

    // subTypes field below is derived from 'superTypes' specified in all ClassificationDef
    ...
    public ClassificationDef(String name) {
        this(name, null, null, null, null, null);
    }

    public ClassificationDef(String name, String description) {
        this(name, description, null, null, null, null);
    }

    public ClassificationDef(String name, String description, String typeVersion) {
    ...
    public ClassificationDef(String name, String description, String typeVersion,
                             List<AttributeDef> attributeDefs, Set<String> superTypes) {
    ...
    public ClassificationDef(ClassificationDef other) {
        super(other);
    ...
    public boolean equals(Object o) {
        ...
        ClassificationDef that = (ClassificationDef) o;
    ...
    @XmlRootElement
    @XmlAccessorType(XmlAccessType.PROPERTY)
    @XmlSeeAlso(ClassificationDef.class)
    public static class ClassificationDefs extends PageInfo<ClassificationDef> {
        private static final long serialVersionUID = 1L;

        public ClassificationDefs() {
            super();
        }

        public ClassificationDefs(List<ClassificationDef> list) {
            super(list);
        }

        public ClassificationDefs(List list, long startIndex, int pageSize, long totalCount,

...
/**
 * RelationshipDef is a TypeDef that defines a relationship.
 * <p>
 * As with other typeDefs the RelationshipDef has a name. Once created the RelationshipDef has a guid.
...
public class RelationshipDef extends StructDef implements java.io.Serializable {
     ...
     *
     */
    public RelationshipDef(String name, String description, String typeVersion,
    ...
    public RelationshipDef(String name, String description, String typeVersion,
                           RelationshipCategory relationshipCategory,
                           PropagateTags propagatetags, RelationshipEndDef endDef1,
                           RelationshipEndDef endDef2, List<AttributeDef> attributeDefs) {
    ...
    public RelationshipDef(RelationshipDef other) {
        super(other);

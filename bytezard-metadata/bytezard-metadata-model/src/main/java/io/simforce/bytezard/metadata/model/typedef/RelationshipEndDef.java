...
public class RelationshipEndDef implements Serializable {
     ...
     */
    public RelationshipEndDef(String typeName, String name, Cardinality cardinality) {
     ...
     */
    public RelationshipEndDef(String typeName, String name, Cardinality cardinality, boolean isContainer) {
     ...
     */
    public RelationshipEndDef(String typeName, String name, Cardinality cardinality, boolean isContainer, boolean isLegacyAttribute) {
     ...
     */
    public RelationshipEndDef(String typeName, String name, Cardinality cardinality, boolean isContainer, boolean isLegacyAttribute, String description) {
        setType(typeName);
        setName(name);
    ...
    /**
     * Construct using an existing RelationshipEndDef
     * @param other
     */
    public RelationshipEndDef(RelationshipEndDef other) {
        if (other != null) {
     ...
     * @param cardinality
     */
    public void setCardinality(StructDef.AttributeDef.Cardinality cardinality) {

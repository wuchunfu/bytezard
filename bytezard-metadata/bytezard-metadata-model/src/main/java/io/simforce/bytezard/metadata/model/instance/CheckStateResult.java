...
public class CheckStateResult implements Serializable {
    ...
    private Map<String, EntityState> entities = null;

    public CheckStateResult() {
    }
    ...
    public Map<String, EntityState> getEntities() {
        return entities;
    }

    public void setEntities(Map<String, EntityState> entities) {
    ...
    public StringBuilder toString(StringBuilder sb) {
        ...
        if (entities != null) {
            ...
            for (Map.Entry<String, EntityState> entry : entities.entrySet()) {
                if (isFirst) {
                    isFirst = false;
                } else {
                    sb.append(",");
    ...
    public static class EntityState implements Serializable {
        ...
        public StringBuilder toString(StringBuilder sb) {
            ...
            sb.append(", state=").append(state);
            sb.append(", issues=[");
            BaseTypeDef.dumpObjects(issues, sb);
            sb.append("]");
            sb.append("}");

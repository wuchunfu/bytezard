...
public abstract class BaseTypeDef implements java.io.Serializable {
    ...
    public static final String TYPE_ARRAY_PREFIX = "array<";
    public static final String TYPE_ARRAY_SUFFIX = ">";
    public static final String TYPE_MAP_PREFIX = "map<";
    public static final String TYPE_MAP_KEY_VAL_SEP = ",";
    public static final String TYPE_MAP_SUFFIX = ">";
     ...
     */
    public static final String[] RELATIONSHIP_ATTRIBUTE_TYPES = {
            TYPE_BOOLEAN,
            TYPE_BYTE,
            TYPE_SHORT,
            TYPE_INT,
    ...
    public static final String SERVICE_TYPE_CORE = "core";
    ...
    protected BaseTypeDef(TypeCategory category,
                          String name, String description, String typeVersion,
    ...
    protected BaseTypeDef(BaseTypeDef other) {
        if (other != null) {
    ...
    public boolean equals(Object o) {
        ...
        BaseTypeDef that = (BaseTypeDef) o;
    ...
    public static String getArrayTypeName(String elemTypeName) {
        return  TYPE_ARRAY_PREFIX + elemTypeName + TYPE_ARRAY_SUFFIX;
    }

    public static String getMapTypeName(String keyTypeName, String valueTypeName) {
        return String.format("%s%s%s%s%s", TYPE_MAP_PREFIX, keyTypeName, TYPE_MAP_KEY_VAL_SEP,
                valueTypeName, TYPE_MAP_SUFFIX);
    }

...
import io.simforce.bytezard.metadata.utils.MultivaluedMapImpl;
...
public class SearchFilter {
    ...
    public static final String PARAM_SUPER_TYPE = "supertype";
    public static final String PARAM_SERVICE_TYPE = "servicetype";
    public static final String PARAM_NOT_SUPER_TYPE = "notsupertype";
    public static final String PARAM_NOT_SERVICE_TYPE = "notservicetype";

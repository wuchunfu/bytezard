...
import io.simforce.bytezard.metadata.model.BaseModelObject;
import io.simforce.bytezard.metadata.model.instance.Classification;

public abstract class GlossaryBaseObject extends BaseModelObject {
    ...
    public GlossaryBaseObject() {
    }

    public GlossaryBaseObject(final GlossaryBaseObject other) {
        super(other);
    ...
    public void setClassifications(final List<Classification> classifications) {
        this.classifications = classifications;
    }

    @JsonIgnore
    public void addClassification(Classification classification) {
        List<Classification> classifications = this.classifications;
    ...
    public boolean equals(Object o) {
        ...
        GlossaryBaseObject that = (GlossaryBaseObject) o;

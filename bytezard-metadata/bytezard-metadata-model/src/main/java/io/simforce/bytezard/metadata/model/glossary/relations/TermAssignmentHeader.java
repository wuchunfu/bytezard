...
import io.simforce.bytezard.metadata.model.glossary.enums.TermAssignmentStatus;
...
public class TermAssignmentHeader {
    ...
    public void setStatus(final TermAssignmentStatus status) {
        this.status = status;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TermAssignmentHeader)) return false;
        final TermAssignmentHeader that = (TermAssignmentHeader) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("TermAssignmentId{");

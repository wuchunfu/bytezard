...
@JSON
public class RelatedCategoryHeader {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RelatedCategoryHeader)) return false;
        final RelatedCategoryHeader that = (RelatedCategoryHeader) o;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("RelatedCategoryId{");

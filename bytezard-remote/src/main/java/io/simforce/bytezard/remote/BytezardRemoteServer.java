...
import io.simforce.bytezard.remote.handler.NettyServerHandler;
 ...
 * @author zixi0825
 */
public class BytezardRemoteServer {

    private final Logger logger = LoggerFactory.getLogger(BytezardRemoteServer.class);
    ...
    public BytezardRemoteServer(NettyServerConfig serverConfig){

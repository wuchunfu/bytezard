package io.datavines.coordinator.api.aop;
...
public class RefreshTokenAop {
    ...
    public Object doAroundReturningAdvice(ProceedingJoinPoint point) {
        ...
        try {
            ...
            if (throwable instanceof DataVinesApiException) {
                DataVinesApiException exception = (DataVinesApiException) throwable;

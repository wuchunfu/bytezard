 ...
 */
package io.datavines.coordinator.server.quartz;
...
public class QuartzExecutors {
  ...
  public static String buildJobName(Long scheduleId) {
    return CoordinatorConstants.QUARTZ_JOB_PREFIX + CoordinatorConstants.UNDERLINE + scheduleId;
  }
  ...
  public static String buildJobGroupName(Long projectId) {
    return CoordinatorConstants.QUARTZ_JOB_GROUP_PREFIX + CoordinatorConstants.UNDERLINE + projectId;
  }
  ...
  public static Map<String, Object> buildDataMap(Long projectId, Long projectFlowId, int scheduleId) {
    ...
    dataMap.put(CoordinatorConstants.PROJECT_ID, projectId);
    dataMap.put(CoordinatorConstants.PROJECT_JOB_ID, projectFlowId);
    dataMap.put(CoordinatorConstants.SCHEDULE_ID, scheduleId);
    return dataMap;
  }

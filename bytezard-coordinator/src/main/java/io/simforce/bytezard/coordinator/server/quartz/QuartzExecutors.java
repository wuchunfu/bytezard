...
import static io.simforce.bytezard.coordinator.Constants.*;
import static io.simforce.bytezard.coordinator.Constants.ORG_POSTGRESQL_DRIVER;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_DATASOURCE_MYDS_CONNECTIONPROVIDER_CLASS;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_ACQUIRETRIGGERSWITHINLOCK;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_CLASS;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_CLUSTERCHECKININTERVAL;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_DATASOURCE;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_DRIVERDELEGATECLASS;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_ISCLUSTERED;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_MISFIRETHRESHOLD;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_TABLEPREFIX;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_JOBSTORE_USEPROPERTIES;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_SCHEDULER_INSTANCEID;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_SCHEDULER_INSTANCENAME;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_SCHEDULER_MAKESCHEDULERTHREADDAEMON;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_THREADPOOL_CLASS;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_THREADPOOL_MAKETHREADSDAEMONS;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_THREADPOOL_THREADCOUNT;
import static io.simforce.bytezard.coordinator.Constants.ORG_QUARTZ_THREADPOOL_THREADPRIORITY;
import static io.simforce.bytezard.coordinator.Constants.PROJECT_ID;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_ACQUIRETRIGGERSWITHINLOCK;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_CLUSTERCHECKININTERVAL;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_DATASOURCE;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_INSTANCEID;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_INSTANCENAME;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_MISFIRETHRESHOLD;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_PROPERTIES_PATH;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_TABLE_PREFIX;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_THREADCOUNT;
import static io.simforce.bytezard.coordinator.Constants.QUARTZ_THREADPRIORITY;
import static io.simforce.bytezard.coordinator.Constants.SCHEDULE_ID;
import static io.simforce.bytezard.coordinator.Constants.STRING_FALSE;
import static io.simforce.bytezard.coordinator.Constants.STRING_TRUE;
import static io.simforce.bytezard.coordinator.Constants.UNDERLINE;
